...
public class PID_Visualator extends PApplet {
  ...
  public void setup()
  {
    ...
    AMButton = controlP5.addButton("Toggle_AM",0.0f,10,50,60,20);      //
    AMLabel = controlP5.addTextlabel("AM","Manual",12,72);            //
    AMCurrent = controlP5.addTextlabel("AMCurrent","Manual",80,65);   //
    controlP5.addButton("Send new values",0.0f,10,475,90,20);         //
    ...
    DRButton = controlP5.addButton("Toggle_DR",0.0f,10,425,60,20);      //
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "PID_Visualator" });
  }
}
